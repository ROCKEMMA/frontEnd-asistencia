...
import { cargarGradosView } from "../views/grados/gradosView.js";
import { moduloUniforme } from "../modules/uniforme/uniformeModulo.js";
...
document.body.appendChild(cargarGradosView("Bachilleratos"));
document.body.appendChild(moduloUniforme("Tipo de Uniforme"));